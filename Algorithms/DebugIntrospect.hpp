#ifndef DEBUGINTROSPECT_HPP_INCLUDED
#define DEBUGINTROSPECT_HPP_INCLUDED
...
/*
    ...
    assembler-disassembler (!?) -> given a list of all known machine instructions, convert any binary sequence
        ...
        // possibly start with older microprocessors which are "released" / "open-source", etc. (but I think that
            // only the ISA is needed, and that's publicly available)

*/

#endif // DEBUGINTROSPECT_HPP_INCLUDED
